...
public final class motor_cmd_t implements lcm.lcm.LCMEncodable
{
    /**
     * LCM Type: float[4]
     */
    ...
    public motor_cmd_t()
    {
        ...
        contactFlag = new float[4];
    }
 
    public static final long LCM_FINGERPRINT;
    public static final long LCM_FINGERPRINT_BASE = 0x8420b9c42b30be1dL;
    ...
    {
        if (classes.contains(lcmtypes.motor_cmd_t.class))
            return 0L;
 
        classes.add(lcmtypes.motor_cmd_t.class);
    ...
    public void _encodeRecursive(DataOutput outs) throws IOException
    {
        ...
        for (int a = 0; a < 4; a++) {
            outs.writeFloat(this.contactFlag[a]); 
        }
 
    }
 
    public motor_cmd_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public motor_cmd_t(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.motor_cmd_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        lcmtypes.motor_cmd_t o = new lcmtypes.motor_cmd_t();
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.contactFlag = new float[(int) 4];
        for (int a = 0; a < 4; a++) {
            this.contactFlag[a] = ins.readFloat();
        }
 
    }
 
    public lcmtypes.motor_cmd_t copy()
    {
        lcmtypes.motor_cmd_t outobj = new lcmtypes.motor_cmd_t();
        ...
        outobj.contactFlag = new float[(int) 4];
        System.arraycopy(this.contactFlag, 0, outobj.contactFlag, 0, 4); 
        return outobj;
    }
