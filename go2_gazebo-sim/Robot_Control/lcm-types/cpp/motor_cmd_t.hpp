...
int motor_cmd_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->contactFlag[0], 4);
    if(tlen < 0) return tlen; else pos += tlen;
...
int motor_cmd_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->contactFlag[0], 4);
    if(tlen < 0) return tlen; else pos += tlen;
...
{
    uint64_t hash = 0x8420b9c42b30be1dLL;
