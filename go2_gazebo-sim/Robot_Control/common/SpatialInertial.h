...
class  SpatialInertia {
 public:
   ...
   * inertia
   * 通过质量和质心和惯量矩阵计算整体的惯量阵
   *公式（3）（8） ，论文 Linear Matrix Inequalitiesfor physically Consistent intertial parameter identification: Statisticcal Perspective on the Mass Distrib
   */
  ...
  /*!
   * Get center of mass location 公式（3）反向求得COM位置
   */
  Vec3<T> getCOM() {
    T m = getMass();
